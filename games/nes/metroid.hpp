...
private:
  ...
  __INLINE__ void getAdditionalAllowedInputs(std::vector<InputSet::inputIndex_t>& allowedInputSet) override
  {
    ...
    allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx});
    if (*_samusAnimation == 0x0001)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_AL, _input_AR, _input_UR, _input_UL});
    if (*_samusAnimation == 0x0002)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_AL, _input_AR, _input_Rs, _input_Ls, _input_UR, _input_UL});
    if (*_samusAnimation == 0x0003)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_AL, _input_AR, _input_Rs, _input_Ls, _input_UR, _input_UL});
    if (*_samusAnimation == 0x0005)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB});
    if (*_samusAnimation == 0x0007)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_R,   _input_L,   _input_U,   _input_A,   _input_D,   _input_DB,  _input_UD,  _input_UL,
                                                     _input_UR,  _input_UB,  _input_UA,  _input_DA,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA,
                                                     _input_LBA, _input_DBA, _input_RBA, _input_UBA, _input_URA, _input_URB, _input_ULA, _input_ULB, _input_UDB});
    if (*_samusAnimation == 0x0008)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_R,   _input_L,   _input_U,   _input_A,   _input_D,   _input_DB,  _input_UD, _input_UL,  _input_UR,
                                                     _input_UB,  _input_UA,  _input_DA,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA, _input_LBA, _input_DBA,
                                                     _input_RBA, _input_UBA, _input_URA, _input_URB, _input_ULA, _input_ULB, _input_UDB, _input_LsA});
    if (*_samusAnimation == 0x000A)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,   _input_R,   _input_U,   _input_A,   _input_L,   _input_D,   _input_UR,  _input_UB,  _input_UA,  _input_UL,  _input_DL,
                              _input_DB,  _input_LR,  _input_UD,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA,  _input_ULB, _input_ULA, _input_URB,
                              _input_UDB, _input_URA, _input_UBA, _input_DLB, _input_DBA, _input_LRB, _input_LBA, _input_RBA, _input_sB});
    if (*_samusAnimation == 0x000B)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_R,   _input_U,   _input_L,   _input_D,   _input_A,   _input_LR, _input_UL,  _input_UR,
                                                     _input_UB,  _input_DL,  _input_DB,  _input_BL,  _input_AL,  _input_BR,  _input_AR, _input_BA,  _input_LBA,
                                                     _input_DBA, _input_RBA, _input_URB, _input_ULB, _input_URA, _input_ULA, _input_sA, _input_RsA, _input_LsA});
    if (*_samusAnimation == 0x000C)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,  _input_R,  _input_U,  _input_A,   _input_L,   _input_UR,  _input_UB,  _input_DL,  _input_DB,  _input_UL,  _input_LR,  _input_BL, _input_AL,
                              _input_BR, _input_AR, _input_BA, _input_ULA, _input_URB, _input_URA, _input_ULB, _input_UBA, _input_DLA, _input_LRA, _input_LBA, _input_RBA});
    if (*_samusAnimation == 0x000D)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,   _input_R,   _input_L,   _input_U,   _input_A,   _input_DB,   _input_UL,   _input_UR,  _input_UB,  _input_UA,  _input_DL,  _input_LR,
                              _input_BL,  _input_BA,  _input_AL,  _input_BR,  _input_AR,  _input_UDA,  _input_ULB,  _input_ULA, _input_URB, _input_URA, _input_UBA, _input_RBA,
                              _input_DLB, _input_DLA, _input_LBA, _input_LRB, _input_LRA, _input_URBA, _input_ULBA, _input_Us,  _input_LsA, _input_Ls,  _input_Rs,  _input_s});
    if (*_samusAnimation == 0x000F)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_R,   _input_L,   _input_A,   _input_D,   _input_DA,  _input_UL,  _input_UR, _input_UB,
                                                     _input_UA,  _input_DB,  _input_LR,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA, _input_LBA,
                                                     _input_DLA, _input_RBA, _input_UBA, _input_URA, _input_URB, _input_ULA, _input_ULB, _input_UDA});
    if (*_samusAnimation == 0x0010)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,  _input_R,  _input_L,  _input_U,  _input_A,   _input_D,   _input_DB,  _input_UL,  _input_UR,  _input_UB,  _input_UA,  _input_BL,
                              _input_AL, _input_BR, _input_AR, _input_BA, _input_LBA, _input_DLA, _input_RBA, _input_UBA, _input_URA, _input_URB, _input_ULA, _input_ULB});
    if (*_samusAnimation == 0x0011)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_R,   _input_A,   _input_L,   _input_U,   _input_Ls,   _input_AL,  _input_UR,  _input_UL,
                                                     _input_UA,  _input_UB,  _input_DB,  _input_BL,  _input_BR,  _input_AR,   _input_BA,  _input_ULA, _input_ULB,
                                                     _input_URB, _input_URA, _input_UBA, _input_LBA, _input_RBA, _input_URBA, _input_ULBA});
    if (*_samusAnimation == 0x0012)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,  _input_R,  _input_L,   _input_U,   _input_A,   _input_DB,  _input_UL,  _input_UR,  _input_UB,  _input_UA, _input_BL, _input_AL, _input_BR,
    ...
    if (*_samusAnimation == 0x0013)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_R, _input_L, _input_D, _input_U, _input_UA, _input_UD, _input_UDR, _input_UR, _input_UL});
    if (*_samusAnimation == 0x0014) allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_R, _input_L, _input_U});
    if (*_samusAnimation == 0x0017)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_R, _input_L, _input_D, _input_U, _input_BR, _input_DR, _input_DL, _input_UD, _input_DRA, _input_DLA,
                                                     _input_UDR, _input_UDL, _input_UL, _input_UR, _input_AL, _input_AR});
    if (*_samusAnimation == 0x0018)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_R, _input_L, _input_D, _input_U, _input_UDR, _input_UL, _input_UR, _input_AL, _input_AR});
    if (*_samusAnimation == 0x0019)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_R, _input_L, _input_D, _input_U, _input_AR, _input_AL, _input_UL, _input_UR, _input_Ls, _input_Rs});
    if (*_samusAnimation == 0x001A)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_R, _input_L, _input_U, _input_AR, _input_AL, _input_UL, _input_UR, _input_Ls, _input_Rs});
    if (*_samusAnimation == 0x0020)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_U,   _input_D,   _input_L,   _input_R,   _input_A,   _input_BR,  _input_UL, _input_UR,  _input_UB,
                                                     _input_UA,  _input_DL,  _input_DB,  _input_BA,  _input_LR,  _input_BL,  _input_AL,  _input_AR, _input_LRA, _input_DLA,
                                                     _input_LBA, _input_UBA, _input_RBA, _input_URA, _input_URB, _input_ULA, _input_ULB, _input_Ls, _input_Rs});
    if (*_samusAnimation == 0x0021)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,   _input_R,   _input_L,   _input_U,   _input_A,   _input_D,   _input_DA,  _input_UL,   _input_UR,  _input_UB,  _input_UA,  _input_DL,
                              _input_DB,  _input_LR,  _input_BA,  _input_BL,  _input_AL,  _input_AR,  _input_BR,  _input_RBA,  _input_ULB, _input_ULA, _input_URB, _input_URA,
                              _input_UBA, _input_LRB, _input_DLB, _input_DLA, _input_DBA, _input_LBA, _input_LRA, _input_URsA, _input_Ls,  _input_Rs});
    if (*_samusAnimation == 0x0023)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_LR, _input_LRB, _input_DLB});
    if (*_samusAnimation == 0x0024)
      allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_AR, _input_AL, _input_LR});
    ...
    if (*_samusAnimation == 0x0027)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_U,   _input_D,   _input_L,   _input_A,   _input_R,   _input_DB,  _input_UL, _input_UR,  _input_UB,
                                                     _input_UA,  _input_UD,  _input_BR,  _input_DA,  _input_BA,  _input_BL,  _input_AL,  _input_AR, _input_UDB, _input_UDA,
                                                     _input_ULB, _input_ULA, _input_URB, _input_URA, _input_UBA, _input_DBA, _input_LBA, _input_RBA});
    if (*_samusAnimation == 0x0028)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,   _input_U,   _input_D,   _input_L,   _input_A,   _input_R,   _input_DB,  _input_UL, _input_UR,  _input_UB,
                                                     _input_UA,  _input_UD,  _input_BR,  _input_DA,  _input_BA,  _input_BL,  _input_AL,  _input_AR, _input_UDB, _input_UDA,
                                                     _input_ULB, _input_ULA, _input_URB, _input_URA, _input_UBA, _input_DBA, _input_LBA, _input_RBA});
    if (*_samusAnimation == 0x0034)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B,  _input_U,  _input_D,  _input_L,  _input_R,  _input_A,  _input_BR, _input_AR,  _input_AL,  _input_BL,  _input_LR,
                                                     _input_BA, _input_DB, _input_UL, _input_DL, _input_UA, _input_UB, _input_UR, _input_ULB, _input_URB, _input_DBA, _input_RBA});
    if (*_samusAnimation == 0x0035)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,   _input_R,   _input_U,   _input_A,   _input_L,   _input_D,   _input_UR,  _input_UB,  _input_UA,  _input_UL,  _input_DL,  _input_DB,
                              _input_DA,  _input_UD,  _input_LR,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA,  _input_ULB, _input_UDB, _input_ULA, _input_URB,
                              _input_URA, _input_UDR, _input_UBA, _input_DLB, _input_DLA, _input_DBA, _input_LRB, _input_LRA, _input_LBA, _input_RBA});
    if (*_samusAnimation == 0x0036)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B,   _input_R,   _input_L,   _input_U,   _input_A,   _input_D,   _input_DB,  _input_UL,  _input_UR,  _input_UB,  _input_UA,
                              _input_DL,  _input_LR,  _input_BL,  _input_AL,  _input_BR,  _input_AR,  _input_BA,  _input_LRA, _input_LBA, _input_DLA, _input_RBA,
                              _input_UBA, _input_URA, _input_URB, _input_ULA, _input_ULB, _input_UDA, _input_UsA, _input_DsA, _input_URs});
    if (*_samusAnimation == 0x0038)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_UD,
                                                     _input_URB, _input_ULB, _input_URA, _input_ULA, _input_s});
    if (*_samusAnimation == 0x0039)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB});
    if (*_samusAnimation == 0x003A)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB});
    if (*_samusAnimation == 0x003C)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B, _input_R, _input_L, _input_U, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB, _input_UDL});
    if (*_samusAnimation == 0x003E)
      allowedInputSet.insert(allowedInputSet.end(),
                             {_input_B, _input_R, _input_L, _input_U, _input_BR, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB});
    if (*_samusAnimation == 0x0040)
      allowedInputSet.insert(allowedInputSet.end(), {_input_B, _input_U, _input_BL, _input_UA, _input_UB, _input_UR, _input_UL, _input_URB, _input_ULB});

    if (_allowPause == true) { allowedInputSet.insert(allowedInputSet.end(), {_input_ALS, _input_LS, _input_RS, _input_S, _input_AS, _input_BS, _input_LRS, _input_BLS}); }
                                              ...
                                              if (input != _input_UsA)
                                                if (input != _input_URBA)
                                                  if (input != _input_ULBA)
                                                    if (input != _input_LRB) newInputSet.push_back(input);
      }
                    ...
                    if (input != _input_URsA)
                      if (input != _input_Us)
                        if (input != _input_Rs)
                          if (input != _input_Ls)
                            if (input != _input_s)
                              if (input != _input_sB) newInputSet.push_back(input);
      }
      allowedInputSet = newInputSet;
    }
  }
  ...
  void printInfoImpl() const override
  {
    ...
    jaffarCommon::logger::log("[J+]  + Enemy States:           [ %02u, %02u, %02u, %02u, %02u, %02u ]\n", *_enemy1State, *_enemy2State, *_enemy3State, *_enemy4State, *_enemy5State,
                              *_enemy6State);
    jaffarCommon::logger::log("[J+]  + Enemy Freeze Timer:     [ %02u, %02u, %02u, %02u, %02u, %02u ]\n", *_enemy1FreezeTimer, *_enemy2FreezeTimer, *_enemy3FreezeTimer,
                              *_enemy4FreezeTimer, *_enemy5FreezeTimer, *_enemy6FreezeTimer);
    jaffarCommon::logger::log("[J+]  + Enemy Active:           [ %02u, %02u, %02u, %02u, %02u, %02u ]\n", *_enemy1Active, *_enemy2Active, *_enemy3Active, *_enemy4Active,
                              *_enemy5Active, *_enemy6Active);
    jaffarCommon::logger::log("[J+]  + Enemy Shape:            [ %02u, %02u, %02u, %02u, %02u, %02u ]\n", *_enemy1Shape, *_enemy2Shape, *_enemy3Shape, *_enemy4Shape, *_enemy5Shape,
                              *_enemy6Shape);
    jaffarCommon::logger::log("[J+]  + Enemy Shape Prev:       [ %02u, %02u, %02u, %02u, %02u, %02u ]\n", _enemy1ShapePrev, _enemy2ShapePrev, _enemy3ShapePrev, _enemy4ShapePrev,
                              _enemy5ShapePrev, _enemy6ShapePrev);
    ...
    jaffarCommon::logger::log("[J+]  + Samus Missile Count:    %02u (Grab State: %02u) (Enough For Boss: %s)\n", *_missileCount, *_missileGrabStatus,
                              _hasEnoughMissilesForBoss ? "True" : "False");
    ...
    if (std::abs(_missileCountMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Missile Count Magnet                    Intensity: %.5f\n", _missileCountMagnet);

    if (std::abs(_missileGrabStatusMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Missile Grab Status Magnet              Intensity: %.5f\n", _missileGrabStatusMagnet);

    if (std::abs(_samusHPMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Samus HP Magnet                         Intensity: %.5f\n", _samusHPMagnet);
    ...
    if (std::abs(_doorTransitionTimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Door Transition Timer Magnet            Intensity: %.5f\n", _doorTransitionTimerMagnet);

    if (std::abs(_door2TimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Door 1 Timer Magnet                     Intensity: %.5f\n", _door1TimerMagnet);

    if (std::abs(_door2TimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Door 2 Timer Magnet                     Intensity: %.5f\n", _door2TimerMagnet);

    if (std::abs(_door2TimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Door 4 Timer Magnet                     Intensity: %.5f\n", _door2TimerMagnet);

    if (std::abs(_enemy5HPMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Enemy 5 HP Magnet                       Intensity: %.5f\n", _enemy5HPMagnet);

    if (std::abs(_enemy5StateMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Enemy 5 State Magnet                    Intensity: %.5f\n", _enemy5StateMagnet);

    if (std::abs(_pauseFrameCounterMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Pause Frame Counter Magnet              Intensity: %.5f\n", _pauseFrameCounterMagnet);

    if (std::abs(_lagFrameCounterMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Lag Frame Count Magnet                  Intensity: %.5f\n", _lagFrameCounterMagnet);

    if (std::abs(_bossPendingHitsMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Boss Pending Hits Manget                Intensity: %.5f\n", _bossPendingHitsMagnet);
    ...
    if (std::abs(_bossPainStateMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Boss Pain State Magnet                  Intensity: %.5f\n", _bossPainStateMagnet);
