...
private:
  ...
  {
    return {"|..|........|", "|..|U.......|", "|..|.D......|", "|..|..L.....|", "|..|...R....|", "|..|.......A|", "|..|......B.|",
            "|..|U.L.....|", "|..|U..R....|", "|..|U......A|", "|..|U.....B.|", "|..|.DL.....|", "|..|.D.R....|", "|..|.D.....A|",
            "|..|.D....B.|", "|..|..L....A|", "|..|..L...B.|", "|..|...R...A|", "|..|...R..B.|", "|..|..LR....|", "|..|.DL....A|",
            "|..|.DL...B.|", "|..|.D.R...A|", "|..|.D.R..B.|", "|..|U.L....A|", "|..|U.L...B.|", "|..|U..R...A|", "|..|U..R..B.|"};
  }
  ...
  __INLINE__ void getAdditionalAllowedInputs(std::vector<InputSet::inputIndex_t>& allowedInputSet) override
  {
    ...
    {
      case 0x0000:
        allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_U, _input_D, _input_L, _input_R, _input_AR, _input_BR, _input_UR, _input_DR, _input_LR, _input_UL,
                                                       _input_UR, _input_DA, _input_DB, _input_URA, _input_URB, _input_ULA, _input_ULB});
        break;
      case 0x0001:
        allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_U, _input_D, _input_L, _input_R, _input_AR, _input_BR, _input_UR, _input_DR, _input_LR, _input_UL,
                                                       _input_UR, _input_DA, _input_DB, _input_URA, _input_URB, _input_ULA, _input_ULB});
      ...
      case 0x0006:
        ...
        break;
      case 0x0010:
        allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_U, _input_D, _input_L, _input_R, _input_AL, _input_BL, _input_UL, _input_DL, _input_LR, _input_UL,
                                                       _input_UR, _input_DA, _input_DB, _input_URA, _input_URB, _input_ULA, _input_ULB});
        break;
      case 0x0011:
        allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_U, _input_D, _input_L, _input_R, _input_AL, _input_BL, _input_UL, _input_DL, _input_LR, _input_UL,
      ...
      case 0x0016:
        ...
        break;
      case 0x0020:
        allowedInputSet.insert(allowedInputSet.end(), {_input_B, _input_U, _input_D, _input_R, _input_DA, _input_DB, _input_DL, _input_UR, _input_DR, _input_DRA, _input_DRB});
        break;
      case 0x0030:
        allowedInputSet.insert(allowedInputSet.end(), {_input_B, _input_U, _input_D, _input_L, _input_DA, _input_DB, _input_UL, _input_DL, _input_DR, _input_DLA, _input_DLB});
        break;
      ...
      default:
        allowedInputSet.insert(allowedInputSet.end(), {_input_A, _input_B, _input_U, _input_D, _input_L, _input_R, _input_AR, _input_BR, _input_UR, _input_DR, _input_LR, _input_UL,
                                                       _input_UR, _input_URA, _input_URB, _input_ULA, _input_ULB});
        break;
    }
  }

  __INLINE__ uint64_t getStateMoveHash() const { return *_heroAction * 16 + *_heroActionTimer; }
  ...
  void printInfoImpl() const override
  {
    ...
    if (std::abs(_heroHPMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Hero HP Magnet                    Intensity: %.5f\n", _heroHPMagnet);
