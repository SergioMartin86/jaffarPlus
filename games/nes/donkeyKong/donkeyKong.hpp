...
private:
  ...
  {
    allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_U, _input_D, _input_L, _input_R, _input_A, _input_AR, _input_DA, _input_UA});
  }
