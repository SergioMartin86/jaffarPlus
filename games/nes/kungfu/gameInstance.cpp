...
//  hash.Update(&_emu->_baseMem[0x0700], 0x100);
  ...
  hash.Update(&_emu->_baseMem[0x0000], 0x0048);
  hash.Update(&_emu->_baseMem[0x0050], 0x0050);
...
std::vector<std::string> GameInstance::getPossibleMoves() const
{
 ...
 if (*heroAction == 0x0000) moveList.insert(moveList.end(), { "......B.", "...U....", "..D.....", ".L......", "R.......", ".......A", "...U...A", "...U..B.", "..DU....", ".L.U....", "RL......", "R......A", "R.....B.", "R..U....", "R.D.....", "RL.U....", "R.DU....", "R..U..B.", "R..U...A", ".L.U..B.", ".L.U...A"});
 ...
 if (*heroAction == 0x0002) moveList.insert(moveList.end(), { "......B.", "...U....", "..D.....", ".......A", ".LD.....", "RL......", "R.D.....", "R..U....", "R.....B.", "R......A", ".L.U....", "...U...A", "..DU....", "..D...B.", "..D....A", "...U..B.", "R..U..B.", "RL.U....", "R.DU....", "R.D...B.", "R.D....A", "..DU..B.", "R..U...A", ".LDU....", "..DU...A", ".L.U..B.", ".L.U...A", "R.DU...A", "R.DU..B."});
 ...
 if (*heroAction == 0x0004) moveList.insert(moveList.end(), { ".......A", "......B."});
 if (*heroAction == 0x0005) moveList.insert(moveList.end(), { ".......A", "......B."});
 ...
 if (*heroAction == 0x0020) moveList.insert(moveList.end(), { ".......A", "...U....", "..D.....", "...U...A", "..DU....", "R......A", "R..U....", "R.D.....", "RL......", "R..U...A", "R.DU...."});
 if (*heroAction == 0x0021) moveList.insert(moveList.end(), { ".......A", "...U....", "..D.....", ".L......", "...U...A", "..DU....", ".L.....A", ".L.U....", ".LD.....", ".L.U...A", ".LDU...."});
...
void GameInstance::printStateInfo(const bool* rulesStatus) const
{
 ...
 LOG("[Jaffar]  + Hero Action:                      %02u (%02u)\n", *heroAction, *heroActionTimer);
