...
std::vector<std::string> GameInstance::getPossibleMoves(const bool* rulesStatus) const
{
 ...
 if (stateMiniHash == 0x0002) moveList.insert(moveList.end(), { "A", "B", "U", "D", "LA", "LB", "UL", "DL" });
 if (stateMiniHash == 0x0020) moveList.insert(moveList.end(), { "A", "B", "U", "LA" });
 if (stateMiniHash == 0x0030) moveList.insert(moveList.end(), { "B", "U", "RB", "UR" });
 if (stateMiniHash == 0x0121) moveList.insert(moveList.end(), { "B", "U", "LB" });
 if (stateMiniHash == 0x0127) moveList.insert(moveList.end(), { "U" });
 if (stateMiniHash == 0x0137) moveList.insert(moveList.end(), { "U", "UR" });
 if (stateMiniHash == 0x0201) moveList.insert(moveList.end(), { "A", "U", "D", "LA", "UL", "DL" });
 if (stateMiniHash == 0x0211) moveList.insert(moveList.end(), { "A", "U", "D", "RA", "UR", "DR" });
 if (stateMiniHash == 0x0221) moveList.insert(moveList.end(), { "A", "U", "LA" });
 if (stateMiniHash == 0x0227) moveList.insert(moveList.end(), { "U", "UL" });
 if (stateMiniHash == 0x0231) moveList.insert(moveList.end(), { "A", "U", "RA", "UR" });
 if (stateMiniHash == 0x0237) moveList.insert(moveList.end(), { "U", "UR" });

 if (stateMiniHash == 0x0000) moveList.insert(moveList.end(), { "DL" });
 if (stateMiniHash == 0x0042) moveList.insert(moveList.end(), { "LR" });
 if (stateMiniHash == 0x0052) moveList.insert(moveList.end(), { "DR" });
 if (stateMiniHash == 0x0211) moveList.insert(moveList.end(), { "D" });
 if (stateMiniHash == 0x0231) moveList.insert(moveList.end(), { "A", "U" });
 if (stateMiniHash == 0x0237) moveList.insert(moveList.end(), { "U" });
