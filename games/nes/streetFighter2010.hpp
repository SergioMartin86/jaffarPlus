...
private:
    ...
    switch (*_playerAction)
    {
      case 0x0000:
        allowedInputSet.insert(allowedInputSet.end(),
                               {_nullInputIdx, _input_A, _input_B, _input_R, _input_L, _input_BA, _input_AR, _input_AL, _input_DA, _input_DB, _input_UB, _input_U});
        break;
      case 0x0001:
        allowedInputSet.insert(allowedInputSet.end(),
                               {_nullInputIdx, _input_A, _input_B, _input_R, _input_L, _input_AR, _input_BR, _input_AL, _input_BL, _input_DB, _input_UB, _input_DRA, _input_DLA});
        break;
      case 0x0002:
        allowedInputSet.insert(allowedInputSet.end(),
                               {_nullInputIdx, _input_A, _input_B, _input_R, _input_L, _input_AR, _input_BR, _input_AL, _input_BL, _input_DA, _input_DB, _input_UB});
        break;
      case 0x0003:
        allowedInputSet.insert(allowedInputSet.end(),
                               {_nullInputIdx, _input_B, _input_R, _input_A, _input_L, _input_D, _input_BA, _input_AR, _input_BR, _input_AL, _input_BL, _input_UB, _input_DA});
        break;
      case 0x0004:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_U, _input_D, _input_L, _input_R, _input_A, _input_BR, _input_AR, _input_AL, _input_BL,
                                                       _input_DA, _input_DB, _input_UB, _input_UD});
        break;
      case 0x0005:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_U, _input_D, _input_L, _input_R, _input_A, _input_BR, _input_AR, _input_AL, _input_BL,
                                                       _input_DA, _input_DB, _input_UB, _input_UD});
        break;
      case 0x0006:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_U, _input_D, _input_L, _input_A, _input_R, _input_BR, _input_AR, _input_AL, _input_BL,
                                                       _input_UD, _input_BA, _input_DA, _input_DB, _input_UB});
        break;
      case 0x0007:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_U, _input_D, _input_L, _input_A, _input_R, _input_BR, _input_AR, _input_AL, _input_BL,
                                                       _input_UD, _input_BA, _input_DA, _input_DB, _input_UB});
        break;
      case 0x0009:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_R, _input_A, _input_L, _input_U, _input_BA, _input_AR, _input_BR, _input_AL, _input_BL,
                                                       _input_UA, _input_UB, _input_DA});
        break;
      case 0x000A:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_B, _input_U, _input_D, _input_L, _input_A, _input_R, _input_BR, _input_AR, _input_AL, _input_BL,
                                                       _input_UD, _input_BA, _input_DA, _input_DB, _input_UB, _input_DLA, _input_DRA});
        break;
      case 0x0010:
        allowedInputSet.insert(allowedInputSet.end(),
                               {_nullInputIdx, _input_B, _input_R, _input_L, _input_BR, _input_BL, _input_DB, _input_DRB, _input_DLB, _input_AR, _input_AL, _input_UL, _input_UR});
        break;
      ...
      default:
        allowedInputSet.insert(allowedInputSet.end(), {_nullInputIdx, _input_U,  _input_D,  _input_L,  _input_R,  _input_A,  _input_B,  _input_UL, _input_UR, _input_UA,
                                                       _input_UB,     _input_UD, _input_DL, _input_DR, _input_DA, _input_DB, _input_AL, _input_BL, _input_AR, _input_BR});
        break;
    }

    if (_allowFire == false && *_playerAction != 0x0A)
      for (ssize_t i = 0; i < (ssize_t)allowedInputSet.size(); i++)
      {
        const auto input = allowedInputSet[i];
        if (input == _input_B || input == _input_UB || input == _input_DB || input == _input_BA || input == _input_BL || input == _input_BR)
        {
          allowedInputSet.erase(allowedInputSet.begin() + i);
          i--;
        }
      }
  }
  ...
  {
    return {"|..|........|", "|..|U.......|", "|..|.D......|", "|..|..L.....|", "|..|...R....|", "|..|.......A|", "|..|......B.|", "|..|U.L.....|",
            "|..|U..R....|", "|..|U......A|", "|..|U.....B.|", "|..|UD......|", "|..|.DL.....|", "|..|.D.R....|", "|..|.D.....A|", "|..|.D....B.|",
            "|..|.DL...B.|", "|..|.D.....A|", "|..|.DL....A|", "|..|.D.R..B.|", "|..|..L....A|", "|..|..L...B.|", "|..|...R...A|", "|..|...R..B.|"};
  }
  ...
  void printInfoImpl() const override
  {
    ...
    jaffarCommon::logger::log("[J+]  + Bullet Directions 01:       [ %03u, %03u, %03u, %03u ]\n", *_bullet00Direction01, *_bullet01Direction01, *_bullet02Direction01,
                              *_bullet03Direction01);
    jaffarCommon::logger::log("[J+]  + Bullet Directions 02:       [ %03u, %03u, %03u, %03u ]\n", *_bullet00Direction02, *_bullet01Direction02, *_bullet02Direction02,
                              *_bullet03Direction02);
    ...
    if (std::abs(_bossDeathTimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Boss Death Timer Magnet             Intensity: %.5f\n", _bossDeathTimerMagnet);
    if (std::abs(_portalTimerMagnet) > 0.0f) jaffarCommon::logger::log("[J+]  + Portal Timer Magnet                 Intensity: %.5f\n", _portalTimerMagnet);
  }
