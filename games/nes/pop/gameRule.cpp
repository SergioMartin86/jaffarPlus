...
datatype_t GameRule::getPropertyType(const nlohmann::json& condition)
{
  ...
  if (propertyName == "Is Bad Render") return dt_uint8;
  ...
  if (propertyName == "Level 3 Skeleton Loose Tile") return dt_uint8;
...
void* GameRule::getPropertyPointer(const nlohmann::json& condition, GameInstance* gameInstance)
{
  ...
  if (propertyName == "Is Bad Render") return gameInstance->isBadRender;
  ...
  if (propertyName == "Level 3 Skeleton Loose Tile") return gameInstance->lvl3SkeletonLooseTile;
