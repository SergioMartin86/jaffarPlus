...
class PrinceOfPersia final : public jaffarPlus::Game
{
  ...
  static __INLINE__ std::string getName() { return "Genesis / Prince Of Persia"; }
  ...
  __INLINE__ void registerGameProperties() override
  {
    ...
    registerGameProperty("Kid Pos X",           &_workRAM[0x001F5A], Property::datatype_t::dt_int16, Property::endianness_t::little);
    registerGameProperty("Kid Pos Y",           &_workRAM[0x001F58], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Kid Room Pos X",      &_workRAM[0x003BF4], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Kid Room Pos Y",      &_workRAM[0x003BF6], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Kid Direction",       &_workRAM[0x0020A8], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Kid Frame",           &_workRAM[0x001F5E], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Kid HP",              &_workRAM[0x001F6A], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Pending Action",      &_workRAM[0x001F62], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Input",               &_workRAM[0x000FDE], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Frame Type",          &_workRAM[0x000D66], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Guard Pos X",         &_workRAM[0x000D0A], Property::datatype_t::dt_int16, Property::endianness_t::little);
    registerGameProperty("Guard Pos Y",         &_workRAM[0x000D08], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Guard HP",            &_workRAM[0x000D18], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    registerGameProperty("Guard Direction",     &_workRAM[0x000D0C], Property::datatype_t::dt_uint16, Property::endianness_t::little);
    ...
    registerGameProperty("Exit Door State",     &_workRAM[0x000D72], Property::datatype_t::dt_uint16, Property::endianness_t::little);
  ...
  __INLINE__ void advanceStateImpl(const InputSet::inputIndex_t input) override
  {
    ...
    auto timer = *_generalTimer;

    // Increasing counter if input is null
    if (input != _nullInputIdx) _lastInputStep = _frameCounter;

    // Running emulator while timer hasn't changed
    int stepCount = 0;
    while (*_generalTimer == timer && stepCount < 5) 
    {
  ...
  __INLINE__ void computeAdditionalHashing(MetroHash128 &hashEngine) const override 
  {
     ...
     if (_hashGuardProperties) hashEngine.Update(&_workRAM[0x0E00], 0x0E00 - 0x0D00);
     if (_hashLevelProperties) hashEngine.Update(&_workRAM[0x0F10], 0x0F30 - 0x0F10);
    ...
    // for (size_t i = 0x0000; i < 0xFFA0; i++) if (i != 0x0FDE && i != 0x0FDF)  hashEngine.Update(_workRAM[i]);
     { uint64_t start = 0x0D00; uint64_t end = 0x0F02; hashEngine.Update(&_workRAM[start], end - start); }
     { uint64_t start = 0x0000; uint64_t end = 0x0100; hashEngine.Update(&_workRAM[start], end - start); }
  ...
  void printInfoImpl() const override
  {
    ...
    if (std::abs(_guardHPMagnet) > 0.0f)
    {
