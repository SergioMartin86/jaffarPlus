...
std::vector<std::string> GameInstance::getPossibleMoves() const
{
 ...
 if (*kidFrame == 0x0001) moveList.insert(moveList.end(), { "B", "L", "R", "U", "LB", "RB", "UL", "UR" });
 if (*kidFrame == 0x0002) moveList.insert(moveList.end(), { "A", "B", "D", "L", "R", "DA", "DL", "DR", "LB", "RB", "UB", "UL", "UR" });
 if (*kidFrame == 0x0003) moveList.insert(moveList.end(), { "B", "L", "R", "DL", "DR", "LB", "RB", "UL", "UR" });
 if (*kidFrame == 0x0004) moveList.insert(moveList.end(), { "L", "R", "DL", "DR", "LB", "RB", "UL", "UR" });
 if (*kidFrame == 0x0005) moveList.insert(moveList.end(), { "L", "R", "U", "DL", "DR", "LB", "RB", "UL", "UR" });
 if (*kidFrame == 0x0006) moveList.insert(moveList.end(), { "L", "R", "DL", "DR", "UL", "UR" });
 ...
 if (*kidFrame == 0x0010) moveList.insert(moveList.end(), { "L", "R", "DL", "DR", "LB", "RB", "UB" });
 if (*kidFrame == 0x0011) moveList.insert(moveList.end(), { "L", "R", "U", "LB", "RB" });
 if (*kidFrame == 0x0012) moveList.insert(moveList.end(), { "D", "L", "R", "LB", "RB" });
 if (*kidFrame == 0x0013) moveList.insert(moveList.end(), { "L", "R", "LA", "LB", "RA", "RB", "UL", "UR" });
 if (*kidFrame == 0x0014) moveList.insert(moveList.end(), { "B", "L", "R", "LB", "RB" });
 if (*kidFrame == 0x0015) moveList.insert(moveList.end(), { "B", "L", "R", "LB", "RB" });
 if (*kidFrame == 0x0016) moveList.insert(moveList.end(), { "LB", "RB" });
 if (*kidFrame == 0x0017) moveList.insert(moveList.end(), { "L", "R" });
 if (*kidFrame == 0x0018) moveList.insert(moveList.end(), { "L", "R", "LB", "RB" });
 ...
 if (*kidFrame == 0x0022) moveList.insert(moveList.end(), { "D", "L", "R", "LB", "RB", "UA", "UB", "UL", "UR" });
 ...
 if (*kidFrame == 0x0025) moveList.insert(moveList.end(), { "LB", "RB" });
 if (*kidFrame == 0x0026) moveList.insert(moveList.end(), { "D", "L", "R", "LB", "RB", "UB" });
 if (*kidFrame == 0x0027) moveList.insert(moveList.end(), { "L", "R", "U", "LB", "RB", "UA", "UB" });
 ...
 if (*kidFrame == 0x002F) moveList.insert(moveList.end(), { "B", "L", "R" });
 if (*kidFrame == 0x0030) moveList.insert(moveList.end(), { "B", "L", "R", "DL", "DR", "LB", "RB", "UL", "UR" });
 if (*kidFrame == 0x0031) moveList.insert(moveList.end(), { "A", "D", "L", "R", "U", "DA", "LA", "LB", "RA", "RB" });
 if (*kidFrame == 0x0032) moveList.insert(moveList.end(), { "A", "B", "D", "L", "U", "R", "UR", "UL", "UB", "UA", "RB", "RA", "LB", "LA", "DR", "DL", "DA", "BA" });
 ...
 if (*kidFrame == 0x0038) moveList.insert(moveList.end(), { "D", "L", "R", "U", "LB", "RB", "UA", "UL", "UR" });
 ...
 if (*kidFrame == 0x004B) moveList.insert(moveList.end(), { "L", "R" });
 if (*kidFrame == 0x004C) moveList.insert(moveList.end(), { "L", "R" });
 ...
 if (*kidFrame == 0x0055) moveList.insert(moveList.end(), { "B", "D", "L", "R", "U", "LA", "LB", "RA", "RB", "UL", "UR" });
 ...
 if (*kidFrame == 0x006D) moveList.insert(moveList.end(), { "A", "D", "U", "L", "R", "UR", "UL", "UB", "RB", "RA", "LB", "LA", "DR", "DL", "DA", "BA" });
 if (*kidFrame == 0x006E) moveList.insert(moveList.end(), { "B", "D", "L", "R", "LB", "RB", "UB", "UL", "UR" });
 if (*kidFrame == 0x006F) moveList.insert(moveList.end(), { "D", "L", "R", "U", "LB", "RB", "UB", "UL", "UR" });
 ...
 if (*kidFrame == 0x0082) moveList.insert(moveList.end(), { "L", "R" });
 ...
 if (*kidFrame == 0x00B2) moveList.insert(moveList.end(), { "L", "R" });
