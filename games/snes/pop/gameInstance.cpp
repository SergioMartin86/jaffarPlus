...
std::vector<std::string> GameInstance::getPossibleMoves() const
{
 ...
 if (*kidFrame == 0x002F) moveList.insert(moveList.end(), { "L", "R" });
 if (*kidFrame == 0x0030) moveList.insert(moveList.end(), { "B", "L", "R", "UL", "UR" });
 if (*kidFrame == 0x0031) moveList.insert(moveList.end(), { "A", "D", "L", "R", "U", "DA", "LA", "LB", "RA", "RB" });
 if (*kidFrame == 0x0032) moveList.insert(moveList.end(), { "A", "B", "D", "L", "U", "R", "UR", "UL", "UB", "UA", "RB", "RA", "LB", "LA", "DR", "DL", "DA" });
 ...
 if (*kidFrame == 0x004A) moveList.insert(moveList.end(), { "L", "R" });
 ...
 if (*kidFrame == 0x00CF) moveList.insert(moveList.end(), { "A", "B", "D", "BA", "LA", "RA" });
 ...
 if (*kidFrame == 0x00E9) moveList.insert(moveList.end(), { "B", "BA" });
