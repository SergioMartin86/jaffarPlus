...
void quickNESInstance::setGameValuePointers()
{
 ...
 _gameControlTimer     = (uint8_t*)  &_baseMem[0x0787];
 _climbSideTimer       = (uint8_t*)  &_baseMem[0x0789];
 _enemyFrameTimer      = (uint8_t*)  &_baseMem[0x078A];
