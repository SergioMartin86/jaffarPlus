...
public:
  ...
  __INLINE__ void serializeState(jaffarCommon::serializer::Base& serializer) const override { serializer.push(_grid, _rowCount * _colCount * sizeof(uint8_t)); };

  __INLINE__ void deserializeState(jaffarCommon::deserializer::Base& deserializer) override { deserializer.pop(_grid, _rowCount * _colCount * sizeof(uint8_t)); };
